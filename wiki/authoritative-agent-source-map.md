...
本页记录本轮网上检索到的权威 agent 开发资料，并标注它们对 OpenCode 通用 agent 与 erun/eVision emu agent 的价值。
...
| 来源 | 权威性 | 重点内容 | 对我们的价值 |
|---|---|---|---|
| [OpenAI Agents SDK](https://developers.openai.com/api/docs/guides/agents) | OpenAI 官方文档 | agent orchestration、tool execution、approvals、state | 支持“应用拥有执行内核和状态”的设计判断 |
| [OpenAI Agents SDK Python Docs](https://openai.github.io/openai-agents-python/agents/) | OpenAI 官方 SDK 文档 | agent 定义、Runner、tools、handoffs、guardrails、results | 可对照我们 TypeScript core 的模块边界 |
...
| [Model Context Protocol Intro](https://modelcontextprotocol.io/docs/getting-started/intro) | MCP 官方文档 | host/client/server、tools/resources/prompts/workflows | 支持未来 MCP 作为 adapter，而不是替代 core |
| [MCP Specification 2025-06-18](https://modelcontextprotocol.io/specification/2025-06-18) | MCP 官方规范 | JSON-RPC、协议角色、规范性要求、安全原则 | 可作为未来 erun MCP server 的协议依据 |
