...
> 说明：来源材料是别人用 AI 对 Claude Code 源码的解析，因此这里把它作为设计参考和模式库，不把其中任何源码细节当作需要照搬的规范。

## 地图

- [[authoritative-agent-source-map]]：网上权威 agent 开发资料来源表。
- [[authoritative-agent-development-guide]]：从官方资料提炼出的 agent 开发攻略。
...
- [[prompt-skill-mcp-patterns]]：prompt runtime、skill、MCP 的边界。
...
- Skill 适合承载人类可读的领域流程，机器执行边界应落在 typed tool / registry。
